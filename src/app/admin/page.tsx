...
<Navbar/>
<h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl pl-5 lg:text-6xl">Hello Admin</h1>
...
<section className="px-6 pt-6">
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                        <div className="flex items-center p-4 rounded-md shadow  :bg-gray-900 bg-gray-50">
                            ...
                            <div>
                                <p className="mb-2 text-gray-700  :text-gray-400">Earnings Annual</p>
                        ...
                        <div className="flex items-center p-4 rounded-md shadow  :bg-gray-900 bg-gray-50">
                            ...
                            <div>
                                <p className="mb-2 text-gray-700  :text-gray-400">Pending Orders</p>
                                <h2 className="text-2xl font-bold text-gray-700  :text-gray-400">
                                    100</h2>
                            </div>
                        </div>
                        <div className="flex items-center p-4 rounded-md shadow  :bg-gray-900 bg-gray-50">
                            ...
                            <div>
                                <p className="mb-2 text-gray-700  :text-gray-400">Pending Requests</p>
                                <h2 className="text-2xl font-bold text-gray-700  :text-gray-400">
                                    56</h2>
                            </div>
                        </div>
    ...
    <div className="pt-4 bg-white rounded shadow  :text-gray-100  :bg-gray-900">
                            <div className="flex px-6 pb-4 border-b  :border-gray-700">
                                <h2 className="text-xl font-bold  :text-gray-400">Transaction</h2>
                            </div>
                                ...
                                <table className="w-full table-auto">
                                    <thead>
                                        <tr className="text-xs text-left text-gray-500  :text-gray-400">
                                            ...
                                            <th className="px-6 pb-3 font-medium ">Occupation </th>
                                            <th className="px-6 pb-3 font-medium">Email </th>
                                            <th className="px-6 pb-3 font-medium">Aadhar Card </th>
                                            <th className="px-6 pb-3 font-medium"> Pan Card </th>
